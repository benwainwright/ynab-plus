...
export const inject = inversifyInject as TypedInject<IDataPorts & IInternalTypes>;

export const multiInject = inversifyInject as TypedMultiInject<IDataPorts & IInternalTypes>;
